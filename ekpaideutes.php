...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>ΕΚΠΑΙΔΕΥΤΕΣ</h2><br>
      <p>
          Χρειάζεστε εκπαιδευτή; Δεν έχετε κάποιον υπόψιν; Έχουμε εμείς κάποιους να σας προτείνουμε. Δείτε παρακάτω και 
          διαλέξτε αυτόν που βρίσκεται πιο κοντά σας.
      </p>
    </div>
    <div class="col-sm-4">
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  <h2>οι εκπαιδευτες μας</h2><br>
  <h4>Εκπαιδευτές που συνεργαζόμαστε και σίγουρα μπορούν να σας βοηθήσουν</h4>
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="./src/karahountris.jpg" alt="karahountris" width="300" height="300">
        <p><strong>Πέτρος Καραχούντρης</strong></p>
        <p>Χαϊδάρι, Αττική</p>
        <a href="https://www.karaxoundris.gr/dogs-training/">Επισκεφτείτε την ιστοσελίδα του!</a> 
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="./src/kostopoulos.jpg" alt="kostopoulos" width="300" height="300">
        <p><strong>Γιώργος Κωστόπουλος</strong></p>
        <p>Αθήνα, Αττική</p>
        <a href="http://www.gkostopoulos.gr/">Επισκεφτείτε την ιστοσελίδα του!</a> 
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="./src/valkanas.jpg" alt="valkanas" width="300" height="300">
        <p><strong>Γιώργος Βαλκανάς</strong></p>
        <p>Μαρούσι, Αττική</p>
        <a href="https://www.valkanasdogs.gr/">Επισκεφτείτε την ιστοσελίδα του!</a> 
      </div>
    </div>
  </div><br>
